...
<head>
    <script>
        function load_new_content() {
            var selected_option_value = $("#select1 option:selected")
                .val(); //get the value of the current selected option.
...
<script type="text/javascript">
    $(document).ready(function(e) {
        $("[name='id']").on('change', function() {
            let id = $('#id').val();
            console.log(id);
            document.getElementById("selectedValue").innerHTML ="<?php if("+id+"==1): ?> id <?php endif; ?>";
        });
    });

</script>
<?php /**PATH C:\Users\z\Documents\GitHub\CS-Laravel\01\resources\views/x/zxc.blade.php ENDPATH**/ ?>